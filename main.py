...
def process_trfix(msg,  self = None):
  ...
  if (fix.get_tag(msg,  35) == '0'):
    ...
    #35=D.49=MD0154300001.56=MFIXTradeIDCurr.34=2.52=20110830-15:50:18.11=657708.1=S01-00000F00.38=100.40=2.44=2386.2032.54=1.55=LKOH.386=1.336=EQBR.59=3.10=004.
    msg = fix.generate_message( OrderedDict([ ('35',  'D'),('11', tagClOrdID_11), ('1','S01-00000F00'), ('38', 50),('40', 2), ('44', 2386.2130), ('54', 1), ('55', 'LKOH'),   ('386', '1'), ('336', 'CETS'), ('59', 0) ] ) )
    self.send(msg)
    #time.sleep(90)
    '''for i in range (1,12):
